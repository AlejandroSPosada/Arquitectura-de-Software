...
ProductShowView, ProductCreateView, ProductCreateSuccess, CartView, CartRemoveAllView, \
...
urlpatterns = [
    ...
    path('products/create/success', ProductCreateSuccess.as_view(), name='product-created'),
